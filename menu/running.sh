...
echo -e "         OWNER : ${GREEN}Kemem vpn ${NC}${YELLOW}(${NC} ${GREEN}bagoesvpn ${NC}${YELLOW})${NC}"
echo -e "       © Recoded By Kemem vpn ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
